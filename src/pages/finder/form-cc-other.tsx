...
const FinderFormCCOther: React.FC<FinderForm> = ({ type, setType, errors, register, loading }) => {
  return (
    <Stack zIndex={2} spacing="0.62rem" color={'white'}>
      <RadioGroupButton
        name="type"
        value={type}
...
export default FinderFormCCOther
